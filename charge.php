<?php require 'partials/_functions.php';
 ...
 $POST = filter_var_array($_POST, FILTER_SANITIZE_STRING);
    ...
    if($paymenyResponse['amount_refunded'] == 0 && empty($paymenyResponse['failure_code']) && $paymenyResponse['paid'] == 1 && $paymenyResponse['captured'] == 1){
            ...
            $p_method = "stripe";
            $insertTransactionSQL = "INSERT INTO stripe_payment(trx_id,bookingCode, fName, email, amt, status, p_date, ddate, payment-method)

            VALUES('".$trx_id."','".$bid."','".$first_name."','".$email."','".$namtPaid."','".$paymentStatus."','".$paymentDate."','".$cdate."','".$p_method."')";
