...
<li>
    <div class="thumb-list-item-caption">
        ...
        <form name="contactForm" action="test2.php" method="POST" class="form-horizontal">

        <div class="thumb-list-item-caption">
   
        <p class="thumb-list-item-title bolded mt10"><a><i class="fa fa-calendar"></i> Depature Date&nbsp;&nbsp;&nbsp; <?php echo $_SESSION['deptDate']?></a></p>
            <p class="thumb-list-item-title bolded mt10"><a><i class="fa fa-clock-o"></i>&nbsp;Depature Time&nbsp;&nbsp;&nbsp; <?php echo $_SESSION['deptTime']?></a> (24Hrs Format)</p>
            ...
            <p class="thumb-list-item-title bolded mt10"><a><i class="fa fa-map-marker"></i> Destination&nbsp;&nbsp;&nbsp; <?php echo strtoupper($str_arr[0])?></a></p>
            ...
            <!-- <div class="thumb-list-item-caption">
                <div class="thumb-list-item-caption">
                    <p class="thumb-list-item-title bolded"><a> Total Cost: <span class="pull-right">&nbsp;&nbsp;&nbsp;&nbsp;₦14,000.00</span></a></p>
                ...
                <!-- <div class="sidebar-widget booking-item-dates-change">
                    ...
                    <h2 class="text-center bolded amount-payable" data-original-amount="13300.00">₦13,300.00</h2>
                </div>
             -->
