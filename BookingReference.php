...
<div class="col-md-12 newstates">
    <div id="faci">
        <h2 align="center">Confirm Your Booking / Reservation</h2>
                                        ...
                                        if($row = mysqli_fetch_assoc($results)) {
                                            ...
                                            if($status == 'cancel'){
                                                if($tt == 'Inter-State'){
                                                    ...
                                                    <span><b>Seat Number   :</b> '.$seat.'</span><br><br>
                                                    <span><b>Departure Date:</b> '.$deptDate.'</span> <span><b class="text-dark" style="font-size:15px; background-color:red; color:white; padding:10px"> Trip Cancel</b></span><br>
                                                ...
                                                elseif($tt == 'Airport-Chater'){
                                                    ...
                                                    <span><b>Departure Date:</b> '.$deptDate.'</span> <span><b class="text-dark" style="font-size:15px; color:white; background-color:red; padding:10px"> Trip Cancel</b></span><br>
                                                    <span><b>Departure Time:</b> '.$deptTime.'</span>
                                                    <br>
                                                    <span><b>Payment Status:</b>  <strong><h3 style="display:inline">'.$pstatus.'</h3></strong></span>
                                            ...
                                            elseif($status =='active'){
                                                ...
                                                if(($cTime > $deptTime) && ($date == $deptDate)) {
                                                    ...
                                                    if($tt == 'Inter-State'){
                                                        ...
                                                        <span><b>Trip From     :</b> '. strtoupper($str_arr[0]) .':- '.$str_arr[1].' <b>To:</b> '.' '. strtoupper($str_arr[2]).' :-'.$str_arr[3].'</span><br>
                                                        <span><b>Seat Number   :</b> '.$seat.'</span><br><br>
                                                        <span><b>Departure Date:</b> '.$deptDate.'</span> <span><b class="'.$clas.' text-dark" style="font-size:15px; padding:5px"> '.$tripstatus.'</b></span><br>
                                                        <span><b>Departure Time:</b> '.$deptTime.'</span>
                                                        <br>
                                                        <span><b>Payment Status:</b>  <strong><h3 style="display:inline">'.$pstatus.'</h3></strong></span>
                                                    ...
                                                    elseif($tt == 'Point-Point'){
                                                        ...
                                                        <span><b>PickOff Address  :</b> '. $paddress.'</span><br>
                                                        <span><b>DropOff Address   :</b> '.$daddress.'</span><br><br>
                                                        <span><b>Departure Date:</b> '.$deptDate.'</span> <span><b class="'.$clas.' text-dark " style="font-size:15px; padding:5px; margin-top: 25px"> '.$tripstatus.'</b></span><br>
                                                        <span><b>Departure Time:</b> '.$deptTime.'</span>
                                                        <br>
                                                        <span><b>Payment Status:</b>  <strong><h3 style="display:inline">'.$pstatus.'</h3></strong></span>
