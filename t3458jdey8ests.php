...
<li>
    <div class="thumb-list-item-caption">
        ...
        <form name="contactForm" action="t78gjgh259bs275est22.php" method="POST" class="form-horizontal" onsubmit="myFunction()">

        <div class="thumb-list-item-caption">
   
        <p class="thumb-list-item-title bolded mt10"><a><i class="fa fa-calendar"></i> Depature Date&nbsp;&nbsp;&nbsp; <?php echo $_SESSION['deptDate']?></a></p>
            <p class="thumb-list-item-title bolded mt10"><a><i class="fa fa-clock-o"></i>&nbsp;Depature Time&nbsp;&nbsp;&nbsp; <?php echo $_SESSION['deptTime']?></a></p>
            ...
            <div class="thumb-list-item-caption">
                <div class="thumb-list-item-caption">
                    ...
                    <p class="thumb-list-item-title bolded"><a><b>Total Cost: <span class="pull-right">&nbsp;&nbsp;&nbsp;&nbsp;$<?php echo $_SESSION['price2']?></span></b></a></p>
                ...
                <div class="sidebar-widget booking-item-dates-change">
                    ...
                    <h2 class="text-center bolded amount-payable">$<?php echo $_SESSION['price2']?></h2>
                </div>
            ...
            if(isset($_SESSION['email'])) { ?>
                            <div class="col-md-6">
                                <div class="form-group form-group-icon-left">
                                   ...
                                   <input type="hidden" name="car" readonly value="<?php echo $_SESSION['bus']?>" id="">
                                </div>
                            </div>
                            <div class="col-md-6">
...
//  print_r($str_arr);
        ...
        <p><small><i class="fa fa-car"></i> Bus / Car Selected: </small><b><?php echo $_SESSION['bus']?></b>
           </p>
        <div class="thumb-list-item-caption">
            <p class="thumb-list-item-title bolded mt10"><a><i class="fa fa-calendar"></i> Depature Date&nbsp;&nbsp;&nbsp; <?php echo $_SESSION['deptDate']?></a></p>
            <p class="thumb-list-item-title bolded mt10"><a><i class="fa fa-clock-o"></i> &nbsp;&nbsp;Depature Time&nbsp;&nbsp;&nbsp; <?php echo $_SESSION['deptTime']?></a></p>
            ...
            <?php 
						for($i=1; $i<16; $i++)
						{
							...
							if(isset($_POST[$chparam]))
							{
								echo "Seat testingNumber <input type='text' style='background-color:#fff; border:0; width:8%; padding-top:12px;' class='span3' name=ch".$i." value=".$i." readonly/><br>";
							}
						}
					?>
            </a></p>
