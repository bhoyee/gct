 ...
 if (mysqli_num_rows($records) > 0) {
  ...
  while($data = mysqli_fetch_array($records))

      {
        ...
        $msg = " No UnPaid Invoice Generated For this Passanger";
              ...
              while($price = mysqli_fetch_array($getPrice))

                  {
                    ...
                    if($tt == 'Inter-State'){
                     ...
                     $pdf->fact_dev( "Trip ", "UnPaid Receipt" );
