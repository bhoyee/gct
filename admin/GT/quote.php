                    ...
                    if (mysqli_num_rows($chkConfNo) > 0){
                      ...
                      while($data = mysqli_fetch_array($records))
                          ...
                          $_SESSION['remail'] = $email;
                            ...
                            $invoice = "insert into invoice (bookingCode, price , tax, date, status) values ('$bookCode', '$tprice', '$tax', '$date', '$status')";
                             ...
                             if(mysqli_query($conn, $invoice)){
                                 ...
                                 //update book table
                                 mysqli_query($conn, "UPDATE book SET price = '$tprice', paystatus = 'UnPaid' WHERE bookingCode ='$bookCode'");
