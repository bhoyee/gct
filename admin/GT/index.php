<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
         ...
         $mr='alert'; //adding bootstrap alert class to div  
      }
   }
?>
<!doctype html>
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login | Giddy Cruise Transport</title>
            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <div class="<?php echo $mr; ?> alert-danger alert-dismissible fade show" role="alert">
                            ...
                            <form class="form-horizontal mt-3" action="" method="post">
                                ...
                                <div class="form-group mb-0 row mt-2">
                                    <div class="col-sm-7 mt-3">
                                        <a href="fPwd.php" class="text-muted"><i class="mdi mdi-lock"></i> Forgot your password?</a>
                                    </div>
