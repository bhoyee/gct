            ...
            <div class="container">
                <div class="row">
                  ...
                  <!--          <li><a href="index.php">Pages</a>
                                ...
                                <li  class="active"><a href="https://giddycruisetransportation.com/faq.php">FAQ</a>
            ...
            <div class="row">
				...
				<div class="col-lg-8">
									...
									<div class="card">
										<div class="card-header" id="headingOne">
											<h5 class="mb-0"><button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
												<span>How much does it cost to arrange a transport?</span>
										...
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
											<div class="card-body">
												The cost of transportation depend on the distance between the Pick area and the drop off.
											</div>
										</div>
									</div>
									<!-- Single FAQ End -->
                  ...
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                      <div class="card-body">
                       You can pay immediately after booking a trip or after the trip and we accept payment via (CashApp, Zelle, Cash, Credit card or Debit card, Bank Transfer).
                  ...
                  <!-- Single FAQ End -->
									...
									<div class="card">
										...
										<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
											<div class="card-body">
											Yes, you need to make reservation before the transportation can be arrange . You can do the <a href = "https://giddycruisetransportation.com/" target="_blank">reservation online</a>
                       , <a href = "mailto: gidicruiztransportation@gmail.com?subject=I%20need%20Transport">Send Email</a>
                      , phone call (+14432202654) or <a href="https://wa.me/14439855520?text=I%20want%20to%20book%20for%20transport" target="_blank">whatsapp</a>.
											</div>
										</div>
									</div>
									...
									<div class="card">
										...
										<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
											<div class="card-body">
												Refund policy is applicable to cancellation of reservation maximum of 1 hour after the booking.
											</div>
										</div>
									</div>
									<!-- Single FAQ End -->
                  ...
                  <div class="card">
                    <div class="card-header" id="heading4">
                      <h5 class="mb-0"><button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                        <span>Do children count as passengers?</span>
                        <i class="fa fa-angle-down"></i>
                        <i class="fa fa-angle-up"></i>
                      </button></h5>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingFour">
                      <h5 class="mb-0"><button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                          <span>Can I change my Pick Up or Return Details after my booking has been processed.</span>
                        <i class="fa fa-angle-down"></i>
                        <i class="fa fa-angle-up"></i>
                        </button></h5>
                    </div>
                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion_2">
                      <div class="card-body">
                        Yes this is possible provided the booking amendment is sent at least 24 hours before a confirmed pick up time.
                  ...
                  <div class="card-header" id="headingSix">
                  	...
                  	<div class="card-body">
                  			If you can't find your answer, kindly get in touch with us via <a href = "mailto: gidicruiztransportation@gmail.com?subject=I%20need%20Transport" target="_blank">Send Email</a>
                       , phone call (+14432202654) or <a href="https://wa.me/14439855520?text=I%20want%20to%20book%20for%20transport" target="_blank">Whatsapp</a>. We are available 24/7 to respond to your request.
                  	</div>
                  </div>
              	</div>
                	<!-- Single FAQ End -->
                    ...
                    <div class="sidebar-content-wrap m-t-50">
                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="sidebar-body">
                                <p><i class="fa fa-mobile"></i> +14432202654</p>
                                <p><i class="fa fa-clock-o"></i> Mon - Sat 8:00 - 23:00</p>
                            </div>
                        </div>
                        <!-- Single Sidebar End -->
                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="sidebar-body">
                                <div class="social-icons text-center">
                                    <a href="https://facebook.com/Giddycruise" target="_blank"><i class="fa fa-facebook"></i></a>
                                    <a href="https://wa.me/14439855520?text=I%20want%20to%20book%20for%20transport" target="_blank"><i class="fa fa-whatsapp"></i></a>
                                    <a href="https://twitter.com/giddycruise" target="_blank"><i class="fa fa-twitter"></i></a>
                                    <a href="https://www.instagram.com/giddycruisetransport" target="_blank"><i class="fa fa-instagram"></i></a>
