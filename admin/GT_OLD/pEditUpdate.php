                ...
                <div class="login-form">
                 ...
                 if(isset($_POST['new']) && $_POST['new']==1)
                 {
                      ...
                      // checking empty fields
                          ...
                          //updating the table
                          $result = mysqli_query($conn, "UPDATE boidata SET fullName='$fname',phone='$fphone',regDate='$fbdate',email='$femail' WHERE id=$id");

                          //redirectig to the display page. In our case, it is index.php
                          // header("Location: index.php");
                          $status = "Record Updated Successfully. </br></br>
                            <a href='psearch.php' class='btn btn-primary btn-lg' >Go Back to Search Page</a>";
                  ...
                  <form action="" method="post">
                    <div class="form-row">
                      ...
                      <div class="col-md-6">
                        <span style="color:#fff">Register Date</span>
