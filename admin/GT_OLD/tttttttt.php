            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-left">
                        <i class="fa fa-map-marker"></i> 8319 Liberty Road, Maryland
                    </div>
                    ...
                    <div class="col-lg-3 text-right">
                        <div class="header-social-icons">
                            ...
                            <a href="https://facebook.com/giddy.cruise.9" target="_blank"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="col-lg-5">
                      ...
                      ?>
                          ...
                          <div class="form-group row">
                              ...
                              <b>  <p style="color:black;font-size:12px;padding-top:10px"> Pick Up Time </p></b>
                    ...
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="about-content">
                                <p>Giddy Cruise Transport is dedicated to provide safe, affordable and convenient Transportation and also offer Private One on One transportation services in these areas
                                  ( <strong> Atlantic Ocean, Baltimore, Delaware, New Jersey, New York, Pennsylvania , Philadelphia, Virginia, Washington </strong> ).
                                <br />  Our aim is to give best and friendly service to our customers.</p>
                                ...
                                <div class="about-btn">
                                    ...
                                    <a href="https://giddycruisetransportation.com/contact.html">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Service Content Start -->
              ...
              <!-- Single Service End -->
   						...
   						<div class="service-item">
   							...
   							<p>We cover BWI Airport,Dulles Airport, JFK Airport,IAD Airport,Newark Airport</p>
   						</div>
   						<!-- Single Service End -->
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <ul class="recent-post">
                                    <li>
                                        <a href="https://facebook.com/giddy.cruise.9" target="_blank">
                                           facebook
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> 8319 Liberty Road, Maryland</li>
...
<script type="text/javascript">function add_chatinline(){var hccid=31247793;var nt=document.createElement("script");nt.async=true;nt.src="https://mylivechat.com/chatinline.aspx?hccid="+hccid;var ct=document.getElementsByTagName("script")[0];ct.parentNode.insertBefore(nt,ct);}
