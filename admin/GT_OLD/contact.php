...
if($_POST) {
    ...
    $email_title = "New Contact Message : Giddy Cruise ";
    $recipient = "support@giddycruisetransportation.com";
    $email_body = "
          ...
          <!--<![endif]-->
              <table class='wrapper' style='border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #ededf1;' cellpadding='0' cellspacing='0' role='presentation'><tbody><tr><td>
                ...
                <div style='mso-line-height-rule: exactly;mso-text-raise: 4px;'>
                  <h1 style='Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #C70039;font-size: 16px;line-height: 24px;text-align: center;'>New Contact Message Alert:</h1><h3 style='Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 14px;line-height: 31px;font-family: Ubuntu,sans-serif;text-align: center;'>You have received a new message alert.</h3>
                </div>
              </div>
                ...
                <div style='mso-line-height-rule: exactly;mso-text-raise: 4px;'>
                  ...
                  <p style='Margin-top: 20px;Margin-bottom: 0;'><em><span style='color:#2c700a'><strong>Client Email</strong></span></em> : <strong>$email </strong></p>
                  <p style='Margin-top: 16px;Margin-bottom: 0;'><em><span style='color:#2e6e0d'><strong>Subject</strong></span></em> : <strong>$subj </strong></p>

                    <p style='Margin-top: 16px;Margin-bottom: 0;'><em><span style='color:#2e6e0d'><strong>Message </strong></span></em> : <strong>$message </strong></p>
    ...
    if(mail($recipient, $email_title, $email_body, $headers)) {
      $msg = 'Thank you for contacting us,' . $name . ', You will get a reply within 24 hours.';
...
<body class="loader-active">
            ...
            <div class="container">
                <div class="row">
                  ...
                  <!--          <li><a href="index.php">Pages</a>
                                ...
                                <li class="active"><a href="https://giddycruisetransportation.com/contact.php">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
                    <!--== Main Menu End ==-->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>We always focus on satisfaction of our valued client.</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 m-auto">
                   Address : <h5><strong>10 Cinnamon Cir, Randallstown, MD 21133, USA</strong></h5> <br />
    ...
    <div class="maparea">
        ...
        <iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=10%20cinnamon%20circle%20Randallstown%20Baltimore%20maryland%2021133+(Giddy%20Cruise%20Transport)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                            ...
                            <div class="single-footer-widget">
                                ...
                                <div class="widget-body">
                                    <ul class="recent-post">
                                        <li>
                                            <a href="https://facebook.com/Giddycruise">
                                               facebook
                                               <i class="fa fa-long-arrow-right"></i>
                                           </a>
                                        </li>
                                        <li>
                                            <a href="https://wa.me/14439855520?text=I%20want%20to%20book%20for%20transport">
                                              whatsapp
                                               <i class="fa fa-long-arrow-right"></i>
                                           </a>
                                        </li>
                ...
                <div class="container">
                  <div class="row">
                      ...
                      <div class="col-lg-10 text-center">
                          <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> Giddy Cruise . All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                      </div>
                  </div>
                </div>
