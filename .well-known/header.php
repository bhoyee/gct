...
<div id="header">
    ...
    <li>
        <a class="no-child" href="index.php">Home</a>
    </li>
    <li>
        <a>About GCT </a>
        <ul>
            ...
            <li>
                <a class="no-child" href="Services.html">Services</a>
            </li>
            <!-- <li>
                <a href="JideOfor.html">Chisco Mascot</a>
            </li>
            <li>
                <a href="KeyMilestone.html">Achievement</a>
            </li> -->
    ...
    <li>
        <a class="no-child" href="airporttrip.php">Airport Transport</a>
    </li>
    <li>
        <a class="no-child" href="Charter.php">Charter</a>
    </li>   
     <li>
